...
class CACHE : public MEMORY {
  public:
    ...
    uint32_t get_set(uint64_t address),
             ...
             llc_find_victim(uint32_t cpu, uint64_t instr_id, uint32_t set, const BLOCK *current_set, uint64_t ip, uint64_t full_addr, uint32_t type,int var=1),
             lru_victim(uint32_t cpu, uint64_t instr_id, uint32_t set, const BLOCK *current_set, uint64_t ip, uint64_t full_addr, uint32_t type,int var=0),
             popt_victim(uint32_t cpu, uint64_t instr_id, uint32_t set,
                           const BLOCK *current_set, uint64_t ip,
                           uint64_t full_addr, uint32_t type,int var),
             victim(uint32_t cpu, uint64_t instr_id, uint32_t set,
                           const BLOCK *current_set, uint64_t ip,
